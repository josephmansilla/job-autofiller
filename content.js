const KEYWORDS = {
    ...
    nationality: ['nationality', 'nacionalidad', 'citizenship', 'ciudadania'],
    ...
    country: ['country', 'país', 'pais', 'nacion', 'nación'],
    identification: ['identification', 'identificacion', 'identificacion', 'documento', 'Nº de documento', 'DNI', 'numero de documento'],
